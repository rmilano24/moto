		...
		<div class="comment-text">
			...
			<?php else : ?>
				...
				<p class="meta">
					...
					?>&ndash; <time itemprop="datePublished" datetime="<?php echo get_comment_date( 'c' ); ?>"><?php printf(__('%1$s at %2$s', 'woocommerce'), get_comment_date( __(get_option('date_format' ), 'woocommerce' ) ) ,  get_comment_time()); ?></time>:
				</p>
