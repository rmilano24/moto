...
$selected     = ep_array_value('selected', $settings, array());//Optional value
$optionsFlags = ep_array_value('option-flags', $settings, array());
$flags        = ep_array_value('flags', $settings);//Optional value
