...
if (!class_exists('MultiPostThumbnails')) {
	...
	class MultiPostThumbnails {
		...
		public function add_metabox() {
			add_meta_box("{$this->post_type}-{$this->id}", __( 'Featured Image' , "multiple-post-thumbnails"), array($this, 'thumbnail_meta_box'), $this->post_type, $this->context, $this->priority);
		}
