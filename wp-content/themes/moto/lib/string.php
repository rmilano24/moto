...
function ep_ends_with($string, $test) {
...
function ep_replace_last_occurrence($haystack, $needle, $replacement) {
...
function ep_remove_last_occurrence($haystack, $needle)
{
    return ep_replace_last_occurrence($haystack, $needle, '');
}

//Simple path combining function
function ep_path_combine($path1, $path2)
{
    ...
    return call_user_func_array('ep_path_combine', $newArgs);
}