...
<div <?php post_class(); ?>>
    ...
    <div class="nav_box">
        ...
        <?php echo previous_post_link('%link', '<div class="button right"><div class="frame top"><div></div></div><div class="frame right"><div></div></div><div class="frame bottom"><div></div></div><div class="frame left"><div></div></div><span class="txt">PREV</span></div>'); ?>
